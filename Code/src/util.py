...
def clean(path):
    """Take a page path and return the text on the page with no punctuation.     
    >>> clean('example_page.html')
    [u'An', u'example', u'webpage', u'This', u'is', u'text', u'line', u'1', u'This', u'is', u'text', u'line', u'2']
...
def has_image(path):
    """Take a page and count number of images.
